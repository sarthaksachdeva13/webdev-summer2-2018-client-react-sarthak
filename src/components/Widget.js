    ...
    return (
        ...
        <div className="container widget-container widgetContainerDiv">
            <div className="col-md-12">
                ...
                <div className="row">
                    <div className="col-md-12">
                        {widget.listType == "ordered" && <div>{orderedFunction(widget.text)} </div>}
                        {widget.listType == "unordered" && <div> {unOrderedFunction(widget.text)}</div>}
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div className="col-md-12">
                            <div className="form-group">
                                <div className="col-md-4">
                                    <img className="img-fluid" src={widget.text} alt={widget.text}/>
                                </div>
